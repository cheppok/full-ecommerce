  ...
  return (
    <div className=''>
                ...
                <div className=" w-[217px]  top-[182px] left-[135px] gap-[16px]  flex flex-col border-r-2 border-gray-300 ">
                  ...
                  <Collapsible>
                      ...
                      <div className='flex space-x-16'>
                          ...
                          {isClose ? <ChevronDown /> : <ChevronRight />}
                        </div> 
                    </CollapsibleTrigger>
                      <CollapsibleContent>
                        <ul className=' pl-10 absolute left-48 bg-gray-50 space-y-4'>
                  ...
                  <Link href={''}>BabyWomen&#39;s & Toys
                  </Link>
                  <Link href={''}>Groceries and Pets
                  </Link>
                ...
                <div className="w-4/5 h-full top-[182px] flex bg-black text-white mt-10">
                      <div className="text w-1/2 text-white flex flex-col pl-20 pt-16 space-y-2">
                          <div className='flex space-x-6 items-center pb-4'> 
                            <Image src={'/images/icons8-apple-60.png'} height={40} width={40} alt='apple'/>
                        ...
                        <div className=' relative pt-8'>
                          <span className='border-b-[1px] border-gray-500 p-1'> shopNow </span>
                        
                        <Image src={'/images/icons8-arrow-32.png'} height={30} width={30}alt='arrow' className='absolute top-8 left-24'/>
                        </div>
                      </div>
                
                      <div className="image w-1/2 ">
                      <Image src={'/images/camera-big.png'} width={2000} height={200} alt='image' className='pt-6'/>
                      </div>
                </div>
              </div>
        </section>
        ...
        <section className='flex justify-between ml-32 mt-6 space-x-8 w-[83vw] overflow-hidden'>
            ...
            <Card name='LPS LCD Gaming Monitor'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)' showNewButton style={{ backgroundImage: "url('/images/lcd-tv.png')" }}/> 
            <Card name='5-Series Comfort Chair'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)'  style={{ backgroundImage: "url('/images/chair.png')" }}/> 
            <Card name='5-Series Comfort Chair'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)'  style={{ backgroundImage: "url('/images/chair.png')" }}/> 
        </section>
        ...
        <SectionHeading title='Best Selling Products'/>
           ...
           <section className='flex justify-between ml-32 mt-6 space-x-8 w-[83vw] overflow-hidden'>
            <Card name='HAVIT HV-G92 Gamepad'  bgClass="bg-center bg-no-repeat bg-center" oldPrice='$200' newPrice='$170' rating='(87)'  style={{ backgroundImage: "url('/images/cloth.png')" }}/> 
            <Card name='A-900 Wired Keyboard'  bgClass="bg-fit bg-no-repeat bg-center" oldPrice='$1130' newPrice='$970' rating='(87)' style={{ backgroundImage: "url('/images/keyboard.png')" }}/> 
            <Card name='IPS LCD Gaming Monitor'  bgClass="bg-fit bg-no-repeat bg-center" oldPrice='$290' newPrice='$160' rating='(87)'  style={{ backgroundImage: "url('/images/lcd-tv.png')" }}/> 
            <Card name='Small Bookshelf'  bgClass="bg-fit bg-no-repeat bg-center" oldPrice='$276' newPrice='$240' rating='(87)'  style={{ backgroundImage: "url('/images/small-cupboard.png')" }}/> 
        </section>   
            
        <section className='flex  justify-between mt-20 bg-black mr-32 ml-32 p-16 h-[500px] relative'>
            <div className='text-white'>
                <p className='text-green-500 text-sm font-semibold tracking-wide'>Categories</p>
                <p className='text-5xl font-semibold pt-10 tracking-wide'>Enhance Your </p>
                <p className='text-5xl font-semibold pt-3 tracking-wider'>Music Experience</p>
                ...
                <LargeButton name='Buy Now' bgColor='bg-green-500' width='w-40'/>
                </div>

            </div>
            <div className='flex items-center'>
                <Image src={'/images/boombox.png'} height={600} width={600} alt='boombox'/>
        ...
        <section className='flex justify-between ml-32 mt-12 space-x-8 w-[83vw] overflow-hidden'>
            <Card name='Breed Dry Dog Food'  bgClass="bg-center bg-no-repeat bg-center" currentPrice='$200' rating='(87)'  style={{ backgroundImage: "url('/images/puppy.png')" }}/> 
            <Card name='CANON EOS DSLR Camera'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)'  style={{ backgroundImage: "url('/images/digitalcamera.png')" }}/> 
            <Card name='ASUS FHD Gaming Laptop'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)'  style={{ backgroundImage: "url('/images/laptop.png')" }}/> 
            <Card name='Curology Product Set'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)' style={{ backgroundImage: "url('/images/curology.png')" }}/> 
        </section>
        <section className='flex justify-between ml-32 mt-6 space-x-8 w-[83vw] overflow-hidden'>
            <Card name='ids Electric car'  bgClass="bg-center bg-no-repeat bg-center" currentPrice='$200' rating='(87)' showNewButton style={{ backgroundImage: "url('/images/redcar.png')" }}/> 
            <Card name='Jr. Zoom Soccer Cleats'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)' style={{ backgroundImage: "url('/images/soccerbooth.png')" }}/> 
            <Card name='GT11 Shooter USB Gamepad'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)' showNewButton style={{ backgroundImage: "url('/images/gamepad-black.png')" }}/> 
            <Card name='Quilted Satin Jacet'  bgClass="bg-fit bg-no-repeat bg-center" currentPrice='$200' rating='(87)'  style={{ backgroundImage: "url('/images/blackjacet.png')" }}/> 
        </section>
        ...
        <section className='flex ml-32 mr-32 mt-12 justify-between '>
            <div className=' h-[600px] w-[650px] bg-black rounded-sm relative  '>
                <Image src={"/images/p5-playstation.png"} height={500} width={500} alt='' className='mt-[100px]'/>
               
               <CardLabel name='Play Station 5' description='Black and white version of PS5' moreDescription='Coming soon' shopNow='SHOP NOW'/>
            </div>
            ...
            <div>
                <div className="flex flex-col h-[600px] w-[650px] space-y-8 ml-8">
                    <div className='bg-black h-72 w-full rounded-sm flex justify-end relative'>
                        <Image src={"/images/woman-cap.png"} height={450} width={450} alt='' />
                        <CardLabel name="Women's Collection" description='Featured woman collection that' moreDescription='give you another vibe' shopNow='SHOP NOW'/>
                    </div>
                    <div className='flex space-x-8 h-72 w-full'>
                        <div className='bg-black w-80 rounded-sm flex justify-center items-center relative'>
                            <Image src={"/images/speaker.png"} height={200} width={200} alt=''  />
                            <CardLabel2 name='Speakers' description='Amason wireless speakers'  shopNow='SHOP NOW'/>
                        </div>
                        <div  className='bg-black w-80 rounded-sm flex justify-center items-center relative '>
                             <Image src={"/images/perfume.png"} height={200} width={200} alt=''  />
                             <CardLabel2 name='Play Station 5' description='Black and white version of PS5' shopNow='SHOP NOW'/>
                        </div>     
                    </div>
