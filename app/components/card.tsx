...
export default function Card({ name, oldPrice, newPrice, currentPrice, rating, showNewButton, bgClass = 'bg-red-600', height = 'h-14', width = 'w-48', style }: TitleProps) {
    return (
        <div className="rounded-lg dark:bg-gray-800 dark:border-gray-700 relative">
           
            <Link href="#">
                <div className={`${bgClass} ${height} ${width} flex justify-center h-[250px] w-[270px] pt-4 bg-gray-200`} style={style}>  
                </div>
            </Link>
